...
var MagicTextArea = Notifier.extend({
    ...
    init: function(jTa){
        ...
        var jWrap1 = jQuery("<div>").css('position','absolute').addClass("magic-wrap1");
        var jWrap2 = jQuery("<div>").css('position','relative').css("display", "inline").addClass("magic-wrap2");
    ...
    addInlineSuggest : function(options){
        ...
        if(typeof(self.suggestionList) == 'undefined'){
            ...
            self.suggestionList= new DropDownList(jSuggest, self.suggestionTemplate);
        ...
        self.addListener({
            caretWordChange : function(w){ 
                ...
                if( w.word[0] == options.trigger || options.trigger == "NONE"){
